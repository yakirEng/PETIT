...
from src.patchnce import PatchNCELoss
from torchvision import transforms
from src.utils.arrays import tens2arr
from src.utils.deep import NetPhase
from src.utils.visualizations import add_text_to_image, full_dynamic_range
...
class CUTModel(BaseModel):
    ...
    def plot_losses(self, tens_board, epoch):
        ...
        for loss_type in losses_types:
            ...
            tens_board.add_scalars(title, scalars, epoch)
