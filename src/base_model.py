...
import torch
from src.configs import LwirChannel
from src.normalizer import Normalizer
from src.physical_model import PanToMono as PhysicalModel
...
class BaseModel(ABC):
    ...
    def set_phase(self, phase: NetPhase):
        ...
        if not isinstance(phase, NetPhase):
            raise TypeError(f"Expected phase to be an instance of NetPhase, got {type(phase)}")
        self.phase = phase
